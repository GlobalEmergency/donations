 ...
 */
final class Version20220310091849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE place (id INT AUTO_INCREMENT NOT NULL, project_id INT NOT NULL, name VARCHAR(255) NOT NULL, longitude DOUBLE PRECISION NOT NULL, latitude DOUBLE PRECISION NOT NULL, description LONGTEXT DEFAULT NULL, address VARCHAR(255) NOT NULL, type VARCHAR(50) NOT NULL, contact_name VARCHAR(255) DEFAULT NULL, contact_phone VARCHAR(30) DEFAULT NULL, contact_email VARCHAR(100) DEFAULT NULL, INDEX IDX_741D53CD166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
